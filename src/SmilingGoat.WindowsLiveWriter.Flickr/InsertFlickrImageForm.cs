...
namespace SmilingGoat.WindowsLiveWriter.Flickr
{
    ...
    public class InsertFlickrImageForm : Form
    {
        ...
        private ImageSize _selectedImageSize = ImageSize.Medium;
        ...
        public FlickrNet.Photo[] SelectedPhotos
        {
            get
            {
                FlickrNet.Photo[] photos = new FlickrNet.Photo[this.retrievedImageList.SelectedIndices.Count];
                for (int i = 0; i < this.retrievedImageList.SelectedIndices.Count; i++)
                {
                    photos[i] = (FlickrNet.Photo)retrievedImageList.Items[retrievedImageList.SelectedIndices[i]].Tag;
                }
        ...
        private void InitializeComponent()
        {
            ...
            this.dropDownImageSizes.SelectedIndexChanged += new System.EventHandler(this.ImageSizeChange);
            // 
            // groupLayout
            // 
            ...
            this.checkHyperLink.Location = new System.Drawing.Point(174, 76);
            ...
            this.checkHyperLink.Visible = false;
            // 
            // textBoxCssClass
            // 
            ...
            this.buttonGetImages.Image = global::SmilingGoat.WindowsLiveWriter.Flickr.Properties.Resources.search16;
            ...
            this.infoButton.Image = global::SmilingGoat.WindowsLiveWriter.Flickr.Properties.Resources.Info;
            ...
            this.flickrLogo.Image = global::SmilingGoat.WindowsLiveWriter.Flickr.Properties.Resources.flickr_gamma;
            ...
            this.pagePrevious.Image = global::SmilingGoat.WindowsLiveWriter.Flickr.Properties.Resources.blueArrowLeft16;
            ...
            this.pageNext.Image = global::SmilingGoat.WindowsLiveWriter.Flickr.Properties.Resources.blueArrowRight16;
        ...
        public InsertFlickrImageForm(FlickrContext context)
        {
            ...
            textboxFlickrUserName.Text = context.FlickrUserName.Trim();
            textBoxTagFilter.Text = context.FlickrTags.Trim();
            _authUserId = context.FlickrAuthUserId;
            _authUserName = context.FlickrAuthUserName;
        ...
        /// <summary>
        /// Eventhandler for the Image Size dropdown.  
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ImageSizeChange(object sender, EventArgs e)
        {
